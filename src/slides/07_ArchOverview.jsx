...
const realisticSteps = [
  ...
  { title: 'Validation / Middleware', icon: Filter, color: 'text-teal-400', bg: 'bg-teal-500/10', border: 'border-teal-500/30' },
  { title: 'Backend Logic', icon: Cpu, color: 'text-violet-400', bg: 'bg-violet-500/10', border: 'border-violet-500/30' },
  { title: 'Cache / External Services', icon: Layers, color: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-purple-500/30' },
